...
def predict(bins_path, model_path, random_seed=20230206, final_col='target', source_file=None, source_df=None, need_padding=True):
    ...
    df = process_for_nn(df_transactions, features, bins, need_padding=need_padding)
    ...
    return pd.DataFrame({"user_id": users, final_col: preds[:, 1]})
